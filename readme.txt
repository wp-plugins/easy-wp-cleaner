...
It adds a settings page to "Dashboard"->"Settings"->"Easy WP Cleaner" where you simply can clean your WordPress database.
It allows you to remove the unnecessary data within few seconds.
It is a super handy tool to keep your database clean with meaningful entries.
It allows you to save a lot of space of your database
